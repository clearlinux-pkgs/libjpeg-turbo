...
Source0  : https://sourceforge.net/projects/libjpeg-turbo/files/3.0.1/libjpeg-turbo-3.0.1.tar.gz
Source1  : https://sourceforge.net/projects/libjpeg-turbo/files/3.0.1/libjpeg-turbo-3.0.1.tar.gz.sig
Source2  : 7EC2DBB6F4DBF434.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 7EC2DBB6F4DBF434' gpg.status
%setup -q -n libjpeg-turbo-3.0.1
cd %{_builddir}/libjpeg-turbo-3.0.1
pushd ..
cp -a libjpeg-turbo-3.0.1 build32
popd
pushd ..
cp -a libjpeg-turbo-3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720052627
mkdir -p clr-build
pushd clr-build
